...
<div className="md:col-span-2 rounded-2xl border border-white/10 bg-slate-900/35 px-5 py-4 text-sm leading-6 text-slate-300">
  ...
  <p className="mt-2">
    Es wird keine Rückgewinnung von Vermögenswerten garantiert. Jede Anfrage wird
    individuell geprüft. Die erste Fallprüfung dient der Orientierung und ersetzt
    keine rechtliche oder finanzielle Beratung.
  </p>
</div>
            {message && (
